   ...
   [..]  This section provides functions allowing to:
      ...
      (+) Configure The time base source to have 1ms time base with a dedicated
        ...
        (++) Source of time base is configured  to generate interrupts at regular
             time intervals. Care must be taken if vTaskDelay() is called from a
...
/**
  ...
  *
  * @note   SysTick is used as time base for the vTaskDelay() function, the application
...
/**
  ...
  *       Care must be taken if vTaskDelay() is called from a peripheral ISR process,
...
/**
  ...
  * @retval None
  */
__weak void vTaskDelay(uint32_t Delay)
{
